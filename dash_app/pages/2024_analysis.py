...
layout = html.Div([
    ...
    html.Img(
        ...
        style={"width": "60%", "display": "block", "margin-left": "2%", "margin-top": "1%"}
    ),
    ...
    html.P('For instance, she lost Bucks County (with a total of 401 thousand votes at stake) after Biden won it by 4 points. That was 16 thousand votes off the table. She won Montgomery county by "only" 23 points, after Biden won it by 26 (with a total of 520 thousand votes at stake). That is another 15-16 thousand votes that shifted. Add this up with 5-7 other fairly large counties in eastern Pennsylvania, and you have more than enough to explain how Trump went from losing by 80,000 to winning by 120,000 votes.'),
    html.P(["Democrats *did* do relatively well in some other suburban areas, nationally. Unlike some other regions there was not the additional factor of a heavy Hispanic population, a drop in black turnout, or Gaza in play here in Pennsylvania. Thus, it would serve them well to understand why they did not hold onto some of their gains in suburban voters in this region. And vice versa for Trump and Republicans, perhaps there is something in their playbook which worked here that might be applied to other suburban areas where they have seen erosion. Perhaps a deep-dive would show that inflation or housing costs were worse in the ",
    ...
    html.P(["Wayne County, where Detroit is located, swung sharply against Harris. Her net margin in votes fell from 332 to 248 thousand--almost a 100 thousand vote falloff. This alone removed well over 1/2 of the Democrats' margin of victory. There were two main factors that probably came into play here. One is that this is a heavily black area, and such counties tend to have pretty flat turnout and slight swings towards Republicans. Secondly, this does not show up in my data, but it is known that the ",
    ...
    html.P('Unlike in Pennsylvania and Michigan, Trump lost ground in Wisconsin''s main suburban counties, in spite of improving his margin overall. The Milwaukie area is known for having the "WOW" counties which constitute its suburban area. These three counties (Washington, Ozaukee, Waukesha) all swung marginally to Kamala Harris, while the rest of the state moved towards Trump.'),
    html.Img(
        src="/assets/nationwide_map_2024_wisconsin_swing.png",
        style={"width": "60%", "display": "block", "margin-left": "15%"}
    ),
    html.P('One potential problem for Democrats in the long-term is southwestern Wisconsin. This area used to be relatively Democratic, especially for a working-class, 90%+ white region. As recently as 2012, Democrats handily won most of the counties in this region. If they continue to vote more like other counties nationally that are demographically similar, they have plenty more room to move to the Republican column. Democrats do not have enough suburban "territory" in Wisconsin to counterbalance that, unless there is a much bigger move towards Democrats in the WOW counties. In 2024, it was likely the significant movement in this area that improved Trump''s overall margin by 50 thousand votes vs. 2020.'),
    html.Img(
